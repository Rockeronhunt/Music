...
// Copyright (c) 2019 The MUSICOIN Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1567492810, nBits=1e0ffff0, nNonce=24422, vtx=1)
...
{
    const char* pszTimestamp = "The new revolution has started in music industry ";
    const CScript genesisOutputScript = CScript() << ParseHex("04c279fc525a037e025a6638d0511daab087ac5e77b30f856afc9367b0f76460fc14a1e68ce9611380d38dfe72eb11f8b01b116de8b7202092d0497726c6380093") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000004dd3f010a9bfb4c02dbb71e6dbff0e1b5bc764db9095c31b8e479a3c055"); 
        ...
        vAlertPubKey = ParseHex("0445ae5bf014934ddf7e30b3165d825657135c991f85c110fb748316aafbba173882cd473e733ed55f9ec40a0b0c0451c81f785f9aed593e1f96ac7747d39a00b5");
        nDefaultPort = 12268;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1567492810, 24422, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000004dd3f010a9bfb4c02dbb71e6dbff0e1b5bc764db9095c31b8e479a3c055"));
        assert(genesis.hashMerkleRoot == uint256S("0xae0c5dd1acad9027666e091fe96455c513c9866816e4b625037c353eb4c90763"));


        vSeeds.push_back(CDNSSeedData("167.99.177.28", "node1.167.99.177.28"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,1);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // MUSICOIN BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // MUSICOIN BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // MUSICOIN BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"1BxhE65Mry3GTRNJHHhGqLZtxery3rpDoG"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x000004dd3f010a9bfb4c02dbb71e6dbff0e1b5bc764db9095c31b8e479a3c055"))
        };

        chainTxData = ChainTxData{
            1567492810, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000af28dd4cb78cfc4da1720d702bde04f8b51f0a8740099afdb4185242bac"); 

        pchMessageStart[0] = 0xfb;
        pchMessageStart[1] = 0x2d;
        pchMessageStart[2] = 0x28;
        pchMessageStart[3] = 0x2e;
        vAlertPubKey = ParseHex("0458827b437fe27ac9de55ffc866f3eccf71b51a5d02921d25ff3e2591b112e5d80ed1c96e943ae433e90860651ea05fa88f651f4d1353eacbdf9e97c9b3b78642");
        nDefaultPort = 22268;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1567492815UL, 1131456UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000af28dd4cb78cfc4da1720d702bde04f8b51f0a8740099afdb4185242bac"));
        assert(genesis.hashMerkleRoot == uint256S("0xae0c5dd1acad9027666e091fe96455c513c9866816e4b625037c353eb4c90763"));
        ...
        // Testnet MUSICOIN BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet MUSICOIN BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet MUSICOIN BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"M9Kvm7upVTJqfrg9AFYkgrEES1mgozYBVb"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000af28dd4cb78cfc4da1720d702bde04f8b51f0a8740099afdb4185242bac"))
        };

        chainTxData = ChainTxData{
            1567492815, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1567492820, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0787d51558ea37361c1f7ed50384022ba28a866b635add6e84acc9c98ea628f8"));
        assert(genesis.hashMerkleRoot == uint256S("0xae0c5dd1acad9027666e091fe96455c513c9866816e4b625037c353eb4c90763"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("musicoinevo.org",  "devnet-seed.musicoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x0787d51558ea37361c1f7ed50384022ba28a866b635add6e84acc9c98ea628f8"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6zFqSZNL4z2A2supEyHZqgu9AdjTeAYvsqHRBpCwNfuNcTzhgfW
        vSporkAddresses = {"MSgkSP6GPbK5acvKXVaYJdcG7Lbhhtz3SZ"};
        nMinSporkKeys = 1;
        ...
        // Regtest MUSICOIN addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest MUSICOIN script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest MUSICOIN BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest MUSICOIN BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest MUSICOIN BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
