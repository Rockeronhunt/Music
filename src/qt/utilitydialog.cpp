...
All the MUSICOIN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MUSIC, 0.01 MUSIC, 0.1 MUSIC, 1 MUSIC and 10 MUSIC -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.musicoin.org/en/latest/wallets/musicoincore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
