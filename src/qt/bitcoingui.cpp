...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and musicoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about MUSICOIN Core"));
    ...
    openAction->setStatusTip(tr("Open a musicoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible MUSICOIN command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("MUSICOIN Core"); // default title
