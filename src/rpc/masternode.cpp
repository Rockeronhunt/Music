...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner MUSICOIN address\n"
            "  payee          - Print the masternode payout MUSICOIN address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting MUSICOIN address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "musicoin",               "masternode",             &masternode,             true,  {} },
    { "musicoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "musicoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "musicoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
