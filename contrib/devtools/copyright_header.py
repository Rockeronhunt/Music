...
Arguments:
    <base_directory> - The base directory of a MUSICOIN Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MUSICOIN Core developers'
...
Arguments:
    <base_directory> - The base directory of MUSICOIN Core source code repository.
"""
...
Arguments:
    <file> - A source file in the MUSICOIN Core repository.
"""
