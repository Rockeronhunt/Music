...
from test_framework.test_framework import MUSICOINTestFramework
...
class LLMQCoinbaseCommitmentsTest(MUSICOINTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as MUSICOINTestFramework doesn't support this atm)
