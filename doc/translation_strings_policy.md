...
This document provides guidelines for internationalization of the MUSICOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `musicoin_en.ts` remains unchanged.
