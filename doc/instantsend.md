...
This mechanism has been integrated into Bitcore-Node-MUSICOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/musicoinpay/insight-api-musicoin#web-socket-api](https://github.com/musicoinpay/insight-api-musicoin#web-socket-api)
* API: [https://github.com/musicoinpay/insight-api-musicoin#instantsend-transactions](https://github.com/musicoinpay/insight-api-musicoin#instantsend-transactions)
